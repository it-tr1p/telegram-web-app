...
users = {
    'Пхукет': [
        {'tg_user_name': 'user_phuket_1', 'tg_user_id': 123456789},
        {'tg_user_name': 'user_phuket_2', 'tg_user_id': 987654321}
    ],
    'Паттайя': [
        {'tg_user_name': 'user_pattaya_1', 'tg_user_id': 123456789},
        {'tg_user_name': 'user_pattaya_2', 'tg_user_id': 987654321}
    ]
}
...
async def enter_budget(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    # Отправляем ответы владельцам в зависимости от выбранного города
    city = answers['city']
    owners = users[city]
